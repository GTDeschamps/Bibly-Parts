...
const Header = () => {
	...
	useEffect(() => {
		// Simuler la récupération du statut de connexion (exemple : depuis le localStorage ou un contexte global)
			...
			<div className="flex items-center space-x-6">
				...
				<div className="relative flex flex-col items-center" ref={menuRef}>
					{isLoggedIn ? (
						...
						<button onClick={handleLogout} className="text-sm text-red-500 mt-1 hover:underline">Déconnexion</button>
					  </div>
					) : (
						<>
							<button
